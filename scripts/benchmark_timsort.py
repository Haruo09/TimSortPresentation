...
def main():
    ...
    times_random = benchmark_c_func(c_lib.timSortAlgo, sizes, gen_random_array)
    times_nearly = benchmark_c_func(c_lib.timSortAlgo, sizes, gen_nearly_sorted_array)
    times_reverse = benchmark_c_func(c_lib.timSortAlgo, sizes, gen_reverse_sorted_array)
